    ...
    public partial class firstA : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CouponHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CouponId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponHistorys", x => x.CouponHistoryId);
                    table.ForeignKey(
                        name: "FK_CouponHistorys_Coupons_CouponId",
                        column: x => x.CouponId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    OrderKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Amount = table.Column<double>(type: "float", nullable: true),
                    CouponAmount = table.Column<double>(type: "float", nullable: true),
                    TotalAmount = table.Column<double>(type: "float", nullable: true),
                    CouponHistoryId = table.Column<int>(type: "int", nullable: true),
                    OrderNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderPay = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CouponHistorys_CouponHistoryId",
                        column: x => x.CouponHistoryId,
                        principalTable: "CouponHistorys",
                        principalColumn: "CouponHistoryId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentNotifications_Banks_BankId",
                        column: x => x.BankId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponHistorys_CouponId",
                table: "CouponHistorys",
                column: "CouponId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CouponHistoryId",
                table: "Orders",
                column: "CouponHistoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentNotifications_BankId",
